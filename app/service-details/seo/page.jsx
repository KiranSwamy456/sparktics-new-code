...
const features = [
  {
    ...
    description:
      "Enhancing your site's structure, content, and meta tags for improved search rankings.",
  },
  {
    title: "Technical SEO",
    description:
      "Fixing issues like site speed and crawl errors to ensure search engine compatibility.",
  },
  {
    title: "Link Building",
    description:
      "Boosting authority through ethical and strategic backlink strategies.",
  },
  {
    title: "Local SEO",
    description:
      "Optimizing for local search to connect with nearby customers and increase foot traffic.",
  },
];
