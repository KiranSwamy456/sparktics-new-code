...
const features = [
  ...
  },
  {
    ...
    description:
      "Designing creative campaigns to maximize influencer impact and engagement.",
  },
  {
    title: "Content Collaboration",
    description:
      "Creating authentic content that resonates with audiences and builds trust.",
  },
  {
    title: "Performance Analysis",
    description:
      "Measuring the reach and success of influencer campaigns to ensure ROI.",
  },
];
  ...
  return (
    <main>
      ...
      <section className="w-full">
        <Image
          src="/assets/images/services/Influencer_Marketing.png"
